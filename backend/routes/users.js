...
router.post(
  ...
  body("role").isIn([Roles.ADMIN, Roles.DOCTOR, Roles.NURSE, Roles.RECEPTION, Roles.PATIENT, Roles.CLINICIAN]),
  async (req, res) => {
...
router.get("/:id", authenticateJWT, permitRoles(Roles.ADMIN), async (req, res) => {
